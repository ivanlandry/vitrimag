            ...
            <nav class="mx-auto site-navigation">
                <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
                    ...
                    <li class="has-children">
                        <a href="job-listings.html">Toutes les annonces</a>
                        <ul class="dropdown">
                    ...
                    <a href="{{ route('add_annonce_get') }}" class="btn btn-outline-white border-width-2 d-none d-lg-inline-block"><span
                            class="mr-2 icon-add"></span>Poster une annonce</a>

                    <li class="d-lg-none"><a href="{{ route('add_annonce_get') }}"><span class="mr-2">+</span> Poster une annonce</a>
                    </li>
